...
REFERENCES directors (director_id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
ALTER TABLE films_directors ADD CONSTRAINT key_directors PRIMARY KEY (film_id, director_id);
